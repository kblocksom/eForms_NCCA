                      ...
                      fluidRow(column(2, imageOutput("oceanImage")),
                               column(6,h2(strong('Tool Overview')), offset=1,
                                      p('The Rapid Data Extraction and Reporting Tool expedites data availability
                                        ...
                                        promote survey awareness and continued sampling support.'),# KEEP THIS PART??
                                      br(),
                                      p('After completing all sampling and sample processing, crews submit data from the app to ',
                                        ...
                                        promote data utility and offers and optional site report based on certain field-collected data, such as field 
                                        parameters, to be sent by the team lead to the landowner shortly 
                                        after sampling.'),
                                      br(),
...
server <- function(input, output, session) {
  ...
  output$report <- downloadHandler(
    ...
    content= function(file){
      ...
      file.copy(imageToSend1, 'NCCA logo_sm.jpg') # same image name
